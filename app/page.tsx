  ...
  return (
    <>
      ...
      <Chapter
        ...
        blurb="Drop a photo or open the webcam. Detection, landmarks and the 128-dimension embedding all run locally with face-api — the image never leaves the browser at this stage. The live view shows every face the detector can see and how sure it is; you press the shutter when the frame looks right."
      >
